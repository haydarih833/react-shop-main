...
export default function DetailsCard({ setAddCart, addCart }) {
    ...
    const handleAddCart = (props) => {
        setAddCart([...addCart, props.cardDetails])
        console.log(addCart)
    }
                        ...
                        <div>
                            <div className="card mb-3 p-3 " style={{ backgroundColor: '#ffffff00', border: 'none' }}>
                                <div className="row g-0">
                                    ...
                                    <div className='changeimg w-50 row flex-lg-column z-0'>
                                        {
                                            cardDetails?.description &&
                                            <>
                                                <img src={cardDetails.images[0]} onClick={() => setChangeImage(0)} className="col-lg-2 col-1 img-fluid rounded-start" />
                                                <img src={cardDetails.images[1]} onClick={() => setChangeImage(1)} className="col-lg-2 col-1 img-fluid rounded-start" />
                                                <img src={cardDetails.images[2]} onClick={() => setChangeImage(2)} className="col-lg-2 col-1 img-fluid rounded-start" />
                                            </>
                                        }
                                    </div>
                                    <div className="col-md-8 w-xxl-50">
                                        <div className="card-body ">
                                            ...
                                            <div className='box-button-deatilsCard mx-auto z-2'>
                                                ...
                                                <button className='rounded-pill text-white z-2' id='bg-button-card-1'>Buy now</button>
                                            </div>
                                            <div className='mt-5'>
